...
const LOCAL_STRINGS = {
  'en-us': {
    ...
    errorCustomerEmailMismatch: 'The checkout email must match the email used to sign in. Please update it or sign out and continue as a guest.',
  ...
  'fr-ca': {
    ...
    errorCustomerEmailMismatch: "L'adresse courriel du paiement doit correspondre à celle utilisée pour vous connecter. Veuillez la modifier ou vous déconnecter et continuer en tant qu'invité.",
    ...
    addressUnvalidatedHeading: "Address Verification / Vérification de l'adresse",
    addressUnvalidatedMessage: "We are unable to verify the address you entered. Please confirm that the address below is correct before proceeding to the next step. / Nous n'avons pas pu vérifier l'adresse saisie. Veuillez confirmer que l'adresse ci-dessous est la bonne avant de passer à l'étape suivante.",
    addressContinueEntered: 'Continue with this address',
    addressChange: 'Change Address',
...
export default async function decorate(block) {
  ...
  const state = {
    ...
    shippingAddressIsValidated: undefined,
    billingAddressIsValidated: undefined,
