...
const LAUNCH_PURCHASE_EVENT = 'purchase';
 ...
 * @returns {{ name: string, qty: number, unitPrice: number }|null}
 */
function normalizePurchaseLineItem(item) {
 ...
 * @returns {boolean}
 */
function shouldTrackPurchaseLine(item) {
 ...
 */
function assignDigitalDataTransaction(transaction) {
  window.digitalData = window.digitalData || {};
  delete window.digitalData.cart;
  delete window.digitalData.product;
