...
const defaults = {
  ...
  strings: {
    'en-us': {
      ...
      cancelFraudDeclined: "We're sorry, but an error occurred while processing your payment. To complete your purchase, please contact our Customer Care team at 1-800-VITAMIX.",
    ...
    'fr-ca': {
      ...
      cancelFraudDeclined: "Nous sommes désolés, mais une erreur s'est produite lors du traitement de votre paiement. Pour finaliser votre achat, veuillez communiquer avec notre équipe du service à la clientèle au 1 800 VITAMIX.",
